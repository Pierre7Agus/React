const recipe = {
    ...
    ingredients: [
        ...
        { name: 'Sal', prepared: false },
        { name: '1 pimiento verde o rojo - picado en cubitos opcional', prepared: false },
        { name: '15-20 limones el jugo', prepared: false },
        { name: '1 manojo de cilantro o culantro picado finamente', prepared: false },
        { name: '1/2 taza de salsa de tomate o tomate licuado/rallado para una versión mas fresca', prepared: false },
    ],
    preparation: [
